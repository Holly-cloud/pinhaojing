...
> 本目录是开发侧：源码、构建、验收、文档。
> **一条命令复现全部验收**：`node dev/_qa/run-gate.mjs`（14 道闸门，自起自收 headless 浏览器）。
...
| `_qa/run-gate.mjs` | ★ **一键闸门**（构建 / 等价性 / verify_v7 / F / G / H+I / 开发态 / W / C / E / P / M / V / v7.19 组），期望 **14/14**（83/18/16/**54**/18/**21**/**31**/**16**/**4**/**9**/**4** + **10**） |
