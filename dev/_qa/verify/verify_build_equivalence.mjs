/* 等价性 / 构建可复现校验：构建产物 vs 交付快照
   ...
   默认判定：断言「node dev/build.mjs 的产出」（= 根目录 PHJ.html）与「当前交付快照
         dev/_qa/snapshots/PHJ_v7.13_20260917.html」**逐字节一致（含 banner，不做 stripBanner）**。
...
const OLD  = process.argv[3] || path.join(ROOT, 'dev', '_qa', 'snapshots', 'PHJ_v7.13_20260917.html');
