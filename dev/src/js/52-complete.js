...
var CMPL_GROUPS = [
  ...
  { label: '起手式', note: '你语料里的三种锚定写法', items: [
    { label: '事件发生在…室内', body: '事件发生在{{node:${1}}}室内。' },
    { label: '镜头N·首帧画面·左右站位', body: '镜头1·{{node:${1}}}首帧画面·画面左侧是{{node:${2}}}${3} 画面右侧是{{node:${4}}}${5}。' },
    { label: '俯视站位参考图', body: '{{node:${1}}}俯视站位参考图·${2}' },
    { label: '场景照片', body: '{{node:${1}}}场景照片。' }
  ] },
  { label: '结构件', items: [
  ...
  { label: '台词', items: [
    { label: '说 + 音色引用', body: '说【{{node:${1}}}音色】：“${2}”' },
    { label: '角色 + 说 + 音色引用', body: '${1}说【{{node:${2}}}音色】：“${3}”' },
    { label: '角色 + 说道 + 音色引用', body: '${1}说道【{{node:${2}}}音色】：“${3}”' }
  ] }
];
